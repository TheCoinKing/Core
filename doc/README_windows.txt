...
Setup
-----
After completing windows setup then run coinking-qt.
Alternatively you can run windows command line (cmd) in coinking program dir.
  cd daemon
  coinkingd
You would need to create a configuration file coinking.conf in the default
wallet directory. Grant access to coinkingd/coinking-qt in anti-virus and firewall
