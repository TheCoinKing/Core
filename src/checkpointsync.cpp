...
// tkcoin: sync-checkpoint master key
...
// tkcoin: synchronized checkpoint (centrally broadcasted)
...
// tkcoin: get last synchronized checkpoint
...
// tkcoin: only descendant of current sync-checkpoint is allowed
...
// tkcoin: reset synchronized checkpoint to last hardened checkpoint
...
// tkcoin: find block wanted by given orphan block
...
// tkcoin: verify signature of sync-checkpoint message
...
// tkcoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in tkcoin)
