 ...
 * tkcoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 55,  // tkcoin: addresses begin with 'P'
        SCRIPT_ADDRESS = 117, // tkcoin: addresses begin with 'p'
