...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        (     0, uint256("0xd9e128be81987a6878f54775494806885ac007a060161a954a33172046c4a5fc")) //remove this check point for next batch
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1514999815, // * UNIX timestamp of last checkpoint block
