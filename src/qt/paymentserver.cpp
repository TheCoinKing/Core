...
const QString BITCOIN_IPC_PREFIX("coinking:");
const char* BITCOIN_REQUEST_MIMETYPE = "application/coinking-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/coinking-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/coinking-payment";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start coinking: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid coinking address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
