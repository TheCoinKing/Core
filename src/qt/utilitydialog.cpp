    ...
    ui(new Ui::AboutDialog)
{
    ...
    tr("Copyright") + QString(" &copy; 2014-%1 ").arg(COPYRIGHT_YEAR) + tr("The coinking Core developers")
        );
}
    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("coinking Core") + " " + tr("version") + " " +
...
void ShutdownWindow::showShutdownWindow(BitcoinGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("coinking Core is shutting down...") + "<br /><br />" +
