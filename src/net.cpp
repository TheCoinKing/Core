...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "coinking " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedcoinking", "seed.coinking.net"},
    {"seed", "seed.tkcoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedcoinking", "tseed.coinking.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. coinking is probably already running."), addrBind.ToString().c_str());
        else
